  ...
  return (
    <footer>
      ...
      <nav className="nav justify-content-center nav-pills flex-column flex-md-row">
        <a className="nav-link active" href="#rest" data-toggle="tab">
          Mock REST
        </a>
        <a className="nav-link" href="#unitTesting" data-toggle="tab">
          Unit Tests
        </a>
        <a className="nav-link" href="#es2015" data-toggle="tab">
          ES2015
        </a>
